...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Vuelos disponbiles con el id 1: ");
        ...
        System.out.println("Vuelos disponibles con destino a FRA");
        ...
        System.out.println("Vuelos disponibles con origen en MAD");
